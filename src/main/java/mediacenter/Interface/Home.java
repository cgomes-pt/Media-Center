...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setForeground(new java.awt.Color(255, 194, 0));
        ...
        jLabel2.setText("Bem-vindo, " + mc.getUser().getUsername() + ".");
        ...
        jLabel3.setForeground(new java.awt.Color(255, 194, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Definiçóes");
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        Definicoes novaJanela = new Definicoes(mc);
        novaJanela.setVisible(true);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        Playlists novaJanela = new Playlists(mc, (HashMap<Integer, playlistsUser>) mc.getUser().getPlayLists());
        novaJanela.setVisible(true);
        dispose();
